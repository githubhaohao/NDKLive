...
#include "include/rtmpdump/rtmp.h"
...
Java_com_haohao_live_jni_NativePush_startPush(JNIEnv *env, jobject instance, jstring url_) {
...
JNIEXPORT void JNICALL
Java_com_haohao_live_jni_NativePush_stopPush(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_haohao_live_jni_NativePush_release(JNIEnv *env, jobject instance) {
